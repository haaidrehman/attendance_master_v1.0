...
<!-- Start Contact Area -->
<section class="std_register_section" style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6))">
    <div class="container">
        <div class="row">
                ...
                <div class="contact-form-wrap mt--60">
                    <div class="col-xs-12">
                        <div class="contact-title">
                            <h2 class="title__line__6">Register</h2>
                        </div>
                    </div>
                    <div class="col-xs-12">
                        <form id="contact-form" method="post" action="<?php echo base_url('/register'); ?>">
                            ...
                            <div class="single-contact-form">
                                <div class="contact-box name pos_relative">
                                    ...
                                    <div class="right_gender_section">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label class="form-check-label"><strong>Gender *</strong></label>
                                            </div>
                                            <div class="col-md-12">
                            ...
                            <div class="single-contact-form my-2">
                                <div class="contact-box name">
                                    <select name="class" id="std_class" class="ht__select" style="width:50%">
                            ...
                            <div class="contact-btn">
                                <button type="submit" id="form_register" class="fv-btn" disabled>Register</button>
                            </div>
