...
<html class="no-js" lang="">
   ...
   <head>
      ...
      <title><?php  $this->renderSection('meta_title'); ?></title>
      ...
      <link rel="stylesheet" href="<?php echo base_url('public/assets/css/pe-icon-7-filled.css'); ?>">
   ...
   <body>
      <?php $this->renderSection('main_section'); ?>
      <script src="<?php echo base_url('public/assets/js/jquery-3.5.1.min.js'); ?>" type="text/javascript"></script>
        <script src="<?php echo base_url('public/assets/js/popper.min.js'); ?>" type="text/javascript"></script>
        <script src="<?php echo base_url('public/assets/js/plugins.js'); ?>" type="text/javascript"></script>
        <script src="<?php echo base_url('public/assets/js/Chart.min.js'); ?>" type="text/javascript"></script>
